...
const ProductDetail = ({ product, openBuyModal, openOfferModal }) => {
    return (
        <div className={styles.productDetail}>
            ...
            <div className={styles.info}>
                ...
                <div className={styles.offerGiven}></div>
                {
                    product.isSold ?<div className={styles.buttonGroup}>
                    <Button text="Satın Al" className="primary" type="button" onClick={() => openBuyModal()} />
                    <Button text="Teklifi Geri Çek" className="secondary" type="button" onClick={() => openOfferModal()} />
                </div>
